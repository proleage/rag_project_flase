...
#     url = f"{rag_config.FILES_URL}/files/{upload_file_id}/file-preview"
#
#     timestamp = str(int(time.time()))
#     nonce = os.urandom(16).hex()
#     key = rag_config.SECRET_KEY.encode()
...
#     url = f"{rag_config.FILES_URL}/files/upload/for-plugin"
#
#     if user_id is None:
...
#     secret_key = rag_config.SECRET_KEY.encode()
...
#     return current_time - int(timestamp) <= rag_config.FILES_ACCESS_TIMEOUT
#
#
